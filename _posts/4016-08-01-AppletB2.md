...
board.create('text', [0, 5.5, function(){return 'h = ' + JXG.toFixed(T.Y(), 2) + 'cm';}], {fontsize:18});
board.create('text', [0, 4.5, function(){return 'A(' + JXG.toFixed(10 - F.X(), 2) + 'cm) = ' + JXG.toFixed((-0.7*(10 - F.X())+7) * (10 - F.X()), 2) + 'cm';}], {fontsize:18});

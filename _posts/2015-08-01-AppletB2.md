...
board.create('text', [-13,11,function(){return 'V(ABCDP) = '+Math.round(100*((104.20*Math.sin(PLK.Value()))/Math.sin(PLK.Value()+60.26*Math.PI/180)))/100}], {fontsize: 18});
board.create('text', [-13,10,function(){return 'V(BCGFP) = '+Math.round(100*((145.88*Math.cos(PLK.Value()))/Math.sin(PLK.Value()+60.26*Math.PI/180)))/100}], {fontsize: 18});

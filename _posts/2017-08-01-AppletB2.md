...
board . create('text', [8.5,8.5, function(){return '|<span style="border-top:1px solid">KP</span>| = '+Math.Round(100*Math.sqrt((K.X()-P.X())*(K.X()-P.X())+(K.Y()-P.Y())*(K.Y()-P.Y())))/100;}], {fontsize: 18, fixed:true});

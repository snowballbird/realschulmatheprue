...
<div id="a71a9e50-b189-4d5a-b44b-479f1f0ec484" class="jxgbox" style="width:500px; height:500px">
<script type="text/javascript">
    (function() {
	const board = JXG.JSXGraph.initBoard('a71a9e50-b189-4d5a-b44b-479f1f0ec484', {
    							boundingbox: [-5, 10, 10, -5],
                  axis: false
              });
 
var A = board.create('point', [-4,0], {fixed:true});

var C = board.create('point', [8,0], {name:'C', fixed:true});

var K = board.create('point', [0,0], {name:'K', fixed:true});

var B = board.create('point', [-2.5,-2.5], {fixed:true});

var D = board.create('point', [2.5,2.5], {fixed:true});
...
var E = board.create('point', [-4, 6]);

var F = board.create('point', [-2.5,3.5]);

var G = board.create('point', [8,6]);

var H = board.create('point', [2.5,8.5]);

var L = board.create('point', [0,6], {name:'L', fixed:true});

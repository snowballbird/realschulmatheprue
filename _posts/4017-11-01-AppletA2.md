...
board.create('text', [10,11, function(){return 'V% = '+Math.round(100*((1/3)*(1/2)*(Math.sqrt((R.X()-Q.X())*(R.X()-Q.X())+(R.Y()-Q.Y())*(R.Y()-Q.Y())))*(Math.sqrt((F.X()-M.X())*(F.X()-M.X())+(F.Y()-M.Y())*(F.Y()-M.Y()))))/196)+'%'}])
})();

...
board.create('text', [10,12,function(){return '|<span style="border-top:1px solid">RQ</span>| = '+Math.round(100*Math.sqrt((R.X()-Q.X())*(R.X()-Q.X())+(R.Y()-Q.Y())*(R.Y()-Q.Y())))/100}], {fontsize:18})
})();

...
//text
var x_T = board.create('text', [1, 5, function(){ return 'x = ' + JXG.toFixed(B.X() - 6, 2);}], {fontsize: 18, fontColor:'purple'});
...
board.create('text', [2.1, function(){return D.X();}, '4,5'], {fontsize:18});

...
var C = board.create('point', [4.5, 3], {name: 'C', fixed:true, label:{fontsize:16}, size:2});

var AC_L = board.create('line', [A,C], {visible: false});
var D = board.create('reflection', [B, AC_L], {name: 'D', fixed: true, trace:function(){return tracestate;}, color:'green', label:{fontsize:16}, size:2})

...
var A = board.create('point', [-1, -2], {name: 'A', fixed:true, label:{fontsize:16}, size:2});
...
var Gp = board.create('functiongraph', [p], {strokecolor: 'blue', strokewidth: 2, withLabel:true, name:'p', label:{fontsize:18, color:'blue'}});

var BAD = board.create('angle', [B, A, D], {orthotype: 'sectordot', name:'BAD', label:{fontsize:16}, radius:1});

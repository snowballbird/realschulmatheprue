...
var phi = board.create('slider', [[-9, 8.5],[-2.8,8.5], [0, 60,180]], {name:'&phi;', label:{fontsize:18});
...
var Gp = board.create('functiongraph', [p], {strokecolor: 'blue', strokewidth: 2, withLabel:true, name:'p');
